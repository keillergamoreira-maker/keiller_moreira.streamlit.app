...
st.set_page_config(
    page_title='Serviço de Internet',
    page_icon=':bar_chart:',
    layout='wide'
)
...
#---Título da página
st.title('Serviço de Internet')
st.subheader('Nesta página veremos a proporção de clientes que assinam o pacote de serviço de internet oferecido pela Telco.')
st.markdown('Pode mos verificar que:\n\n '
            '- _**78,30%**_ dos clientes assinam o serviço de internet, totalizando _**5.517**_ clientes;\n\n '
            '- _**21,70%**_ dos clientes não assinam o serviço de internet, totalizando _**1.526**_ clientes.')
