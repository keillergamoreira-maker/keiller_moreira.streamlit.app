...
st.set_page_config(
    page_title='Número de Cancelamentos',
    page_icon=':bar_chart:',
    layout='wide'
)
...
#===Título da página
st.title('Número de Cancelamentos')
st.subheader('Nesta página veremos por meio dos gráficos de pizza e histograma o número de cancelamentos que ocorreram '
             'no período de análise, onde: _"Yes"_ representa o número de clientes que efetuaram o cancelamento de seus '
             'planos e _"No"_ representa os clientes que permaneceram com os serviços prestados pela Telco.')

st.markdown('Podemos observar que:\n\n '
            '- Houve um total de _**1.869**_ cancelamentos, representando uma queda de _**26,50%**_ no número de '
            'de clientes da empresa no período.')
